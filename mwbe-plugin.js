...
(function($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        getVendorsByService: function (service) {
          ...
          $.ajax({url: 'https://services.arcgis.com/v400IkDOw1ad7Yad/arcgis/rest/services/NC_Certified_Minority_and_Women_Owned_Businesses_Directory/FeatureServer/0/query', dataType: 'json', data: {where: "services in '"+service+"'",f:"json",outFields:"*"}}).done(function (data) {
